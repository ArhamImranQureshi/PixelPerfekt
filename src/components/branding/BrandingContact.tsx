...
export function BrandingContact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Branding Contact Form Submitted:", formData);
  ...
  return (
    <section
      id="contact"
      className="relative bg-cover bg-center py-16 md:py-20 lg:py-[120px] overflow-hidden"
      style={{ backgroundImage: "url('/images/227_1-1-copyright 1.png')" }}
    >
          ...
          <div className="flex flex-col gap-12 lg:flex-row lg:gap-16">
            ...
            >
              <div>
                ...
                <p className="mb-8 mt-4 text-base leading-relaxed text-white/70">
                  Ready to start your brand journey? Reach out and let&apos;s discuss how we can bring your vision to life.
                </p>
              </div>
            ...
            <motion.div variants={fadeIn} className="flex-1">
              <h3 className="mb-8 text-4xl sm:text-5xl font-bold tracking-[-0.03em] text-white">
                Get Started
                <span className="block h-1 w-12 bg-[#2CB6C0] mt-2 rounded" />
              </h3>
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  ...
                  <div className="relative group">
                    ...
                    >
                      ...
                      <option value="brand-strategy" className="text-black">
                        Brand Strategy
                      </option>
                      <option value="visual-identity" className="text-black">
                        Visual Identity
                      </option>
                      <option value="brand-guidelines" className="text-black">
                        Brand Guidelines
                      </option>
                    </select>
                    <svg

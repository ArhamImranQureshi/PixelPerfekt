          ...
          <div className="grid gap-12 sm:grid-cols-2">
            ...
            <div>
              ...
              <dl className="mt-6 space-y-6">
                <div>
                  <dt className="text-sm font-medium text-zinc-500 dark:text-zinc-500">Email</dt>
                  <dd className="mt-1">
                    <a href={`mailto:${siteConfig.email}`} className="text-zinc-900 transition-colors hover:text-indigo-500 dark:text-white">
                      {siteConfig.email}
                    </a>
                  </dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-zinc-500 dark:text-zinc-500">Phone</dt>
                  <dd className="mt-1">
                    <a href={`tel:${siteConfig.phone}`} className="text-zinc-900 transition-colors hover:text-indigo-500 dark:text-white">
                      {siteConfig.phone}
                    </a>
                  </dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-zinc-500 dark:text-zinc-500">Address</dt>
                  <dd className="mt-1 text-zinc-900 dark:text-white">{siteConfig.address}</dd>
                </div>
              </dl>
            </div>
          </div>
